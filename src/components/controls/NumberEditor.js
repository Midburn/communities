    ...
    render() {
        ...
        return (
            ...
            <span disabled={max !== 'undefined' && this.value >= max} onClick={this.increment} id="increment" className="handle">
                ...
                <input type="number" data-hook="number-input" value={this.value}
                       onKeyDown={this.handleKeyDown}
                       onChange={this.handleChange}/>
                <span disabled={max !== 'undefined' && this.value <= min} onClick={this.decrement} id="decrement" className="handle">
                <TiMinus />
            </span>
            </div>
        );
