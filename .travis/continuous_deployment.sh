...
then
    openssl aes-256-cbc -K $encrypted_84fd3d8d0d55_key -iv $encrypted_84fd3d8d0d55_iv -in k8s-ops-secret.json.enc -out ../midburn-k8s/secret-midburn-k8s-ops.json -d
