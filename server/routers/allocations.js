...
module.exports = class AllocationsRouter {
  ...
  initRoutes () {
    ...
    /**
         * Add/Update / Get buckets
         * E.G POST/GET - api/VERSION/allocations/buckets/theme_camps/pre_sale/MIDBURN2019
         */
    this.router
      .route ('/allocations/buckets/:group_type/:allocation_type/:event_id')
      .get (this.controller.getBuckets)
